...
const translations: Record<Language, Record<string, string>> = {
  en: {
    ...
    'nav.sizer': 'Project Sizer & Estimator',
    'nav.contact': 'Contact Us',
    'nav.profile': 'Portal',
    'home.hero_title': 'Complete Solutions for Contracting, Electrical Works, Safety Systems & CCTV',
    'home.hero_subtitle': 'Professional execution according to the highest quality standards. Proven experience in government and commercial projects.',
    ...
    'service.fire_alarm': 'Early Alarm Systems',
    ...
    'service.cooling.desc': 'Central chilled water infrastructure, Package units, ducted systems, and automated control systems for massive complexes.',
  ...
  ar: {
    ...
    'nav.sizer': 'تسعير ومقايسة المشاريع',
    'nav.contact': 'اتصل بنا',
    'nav.profile': 'بوابة العملاء',
    'home.hero_title': 'حلول متكاملة للمقاولات والأعمال الكهربائية وأنظمة السلامة وكاميرات المراقبة',
    'home.hero_subtitle': 'تنفيذ احترافي وفق أعلى معايير الجودة، وخبرة متميزة في المشاريع الحكومية والتجارية.',
    ...
    'service.fire_alarm.desc': 'مجسات حرارية ودخانية متطورة متصلة بلوحات معالجة موجهة، أنظمة طوارئ وتدابير مكافحة الحوادث والإنذار الصوتي.',
    'service.cooling': 'أنظمة التكييف والتهوية والتبريد HVAC',
    'service.cooling.desc': 'توريد وتركيب التكييف المركزي تشيلرز (Chillers)، وحدات دكت مدمجة، وحلول التحكم والتهوية المتكاملة للأبراج والمولات الصناعية.',
    ...
    'service.cctv.desc': 'توريد وتركيب شبكات كاميرات المراقبة للشركات والمصانع، أنظمة الكشف عن الحركة والتعرف الرقمي المعتمد، التحكم بالأبواب بيومترياً وتأسيس غرف المراقبة.',
  }
};
