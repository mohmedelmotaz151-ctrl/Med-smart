...
const translations: Record<Language, Record<string, string>> = {
  en: {
    ...
    'home.hero_subtitle': 'Pioneering Electro-Mechanical installations, Fire Fighting systems, Early Alarm Systems, Industrial Cooling, and Power Solutions across the GCC region.',
  ...
  ar: {
    ...
    'home.hero_subtitle': 'الشركة الرائدة في تنفيذ المشروعات الكهروميكانيكية، شبكات مكافحة الحرائق، أنظمة الإنذار المبكر والتحكم، التكييف المركزي، وتوليد الطاقة البديلة في دول الخليج.',
